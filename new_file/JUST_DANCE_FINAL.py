...
class Just_Dance():
    ...
    def draw_poses(self, img, poses, point_score_threshold, skeleton=self.default_skeleton):
    ...
    def run_pose_estimation(self, source=0, flip=False, use_popup=False, skip_first_frames=0):
        ...
        try:
            ...
            while True:
                ...
                traking_image, answer_list = self.draw_poses(traking_image, poses, 0.1)
                traking_image1, player_list = self.draw_poses(traking_image1, poses1, 0.1)
